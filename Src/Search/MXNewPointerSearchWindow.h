...
namespace mx {
	...
	class CNewPointerSearchWindow : public lsw::CMainWindow {
	public :
		CNewPointerSearchWindow( const LSW_WIDGET_LAYOUT &_wlLayout, CWidget * _pwParent, bool _bCreateWidget = true, HMENU _hMenu = NULL, uint64_t _ui64Data = 0 );
