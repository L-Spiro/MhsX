#include "MXExpressionSubsearchLayout.h"
...
#define MX_FPS_H				940
	...
	LSW_WIDGET_LAYOUT CExpressionSubsearchLayout::m_wlMainWindow[] = {
		{
			MX_PE_WORKS,							// ltType
			MX_C_MAINWINDOW,						// wId
			nullptr,								// lpwcClass
...
#undef MX_FPS_H
	...
	CWidget * CExpressionSubsearchLayout::CreateTemplateWindow( CWidget * _pwParent ) {
