...
namespace mx {
	...
	LSW_MENU_ITEM CMainWindowLayout::m_miOptionsMenu[] = {
		...
		{ TRUE,			0,							FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_MWMI_DEUS_HEX_MACHINA,	FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_EAEFED39_Deus__Hex_Machina, _LEN_EAEFED39 ),							false,	{ static_cast<BYTE>(FVIRTKEY | FCONTROL), 'H', MX_MWMI_DEUS_HEX_MACHINA } },
		{ TRUE,			0,							FALSE,		FALSE,		TRUE,		nullptr },
