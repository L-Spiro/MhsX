...
namespace yy {
  ...
  /* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
     STATE-NUM.  */
  const signed char CExpEvalParser::yypact_ninf_ = -28;
  const signed char
  ...
  const int CExpEvalParser::yylast_ = 84;
  const int CExpEvalParser::yynnts_ = 19;
  const int CExpEvalParser::yyempty_ = -2;
  const int CExpEvalParser::yyfinal_ = 70;
  const int CExpEvalParser::yyterror_ = 1;
  const int CExpEvalParser::yyerrcode_ = 256;
  const int CExpEvalParser::yyntokens_ = 50;

  const unsigned int CExpEvalParser::yyuser_token_number_max_ = 286;
