...
#undef MX_W_H
	...
	LSW_MENU_ITEM CDeusHexMachinaLayout::m_miEditCopyAsMenu[] = {
		...
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_EDIT_COPY_AS_INT8,							FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_F0B77A2C_Copy_as_Si_gned_Byte, _LEN_F0B77A2C ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_UINT8,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_28F72D0D_Copy_as_Unsigned_B_yte, _LEN_28F72D0D ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_INT16,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_22733CC4_Copy_as_Signed_Sh_ort, _LEN_22733CC4 ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_UINT16,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_A4F10B36_Copy_as_Unsigned__Short, _LEN_A4F10B36 ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_INT32,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_097E3289_Copy_as_Signed_I_nt, _LEN_097E3289 ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_UINT32,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_08B38BA4_Copy_as_Unsigned__Int, _LEN_08B38BA4 ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_INT64,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_648FDCFB_Copy_as_Sign_ed_Int64, _LEN_648FDCFB ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_UINT64,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_83AF5F77_Copy_as_Unsigned_Int_64, _LEN_83AF5F77 ) },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_EDIT_COPY_AS_P16,							FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_B4642DA6_Copy_as__Pointer_16, _LEN_B4642DA6 ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_P32,							FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_6CFFE652_Copy_as_P_ointer_32, _LEN_6CFFE652 ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_P64,							FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_947FD0C5_Copy_as_Poin_ter_64, _LEN_947FD0C5 ) },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_EDIT_COPY_AS_FLOAT10,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_2E839B08_Copy_as_Float10, _LEN_2E839B08 ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_FLOAT11,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_5984AB9E_Copy_as_Float11, _LEN_5984AB9E ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_BFLOAT,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_7FB6B6AB_Copy_as_BFlo_at, _LEN_7FB6B6AB ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_FLOAT16,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_C7E03E3D_Copy_as_Float16, _LEN_C7E03E3D ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_FLOAT32,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_AC190447_Copy_as__Float32, _LEN_AC190447 ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_FLOAT64,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_6350B969_Copy_as_F_loat64, _LEN_6350B969 ) },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_EDIT_COPY_AS_PCM8,							FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_1989F106_Copy_as_PCM8, _LEN_1989F106 ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_PCM16,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_37E9D9E4_Copy_as_P_CM16, _LEN_37E9D9E4 ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_PCM24,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_AFE01407_Copy_as_PC_M24, _LEN_AFE01407 ) },
		{ FALSE,		MX_M_EDIT_COPY_AS_PCM32,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_DA65533F_Copy_as_PCM3_2, _LEN_DA65533F ) },
	};
	...
	LSW_MENU_ITEM CDeusHexMachinaLayout::m_miSelectMenu[] = {
		...
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_SELECT_EXPAND_SELECTION,					FALSE,		FALSE,		FALSE,		MW_MENU_TXT( _T_48180F4F_E_xpand_Selection, _LEN_48180F4F ),				false,	{ static_cast<BYTE>(FVIRTKEY | FCONTROL), 'J', MX_M_SELECT_EXPAND_SELECTION } },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
	...
	LSW_MENU_ITEM CDeusHexMachinaLayout::m_miViewMenu[] = {
		...
		{ FALSE,		MX_M_VIEW_LEFT_AREA,							FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_CC81C3B0_Lef_t_Area, _LEN_CC81C3B0 ) },
	...
	LSW_MENU_ITEM CDeusHexMachinaLayout::m_miViewFontMenu[] = {
		...
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_VIEW_FONT_ENLARGE_FONT,					FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_5E30F3F6__Enlarge_Font, _LEN_5E30F3F6 ),					false,	{ static_cast<BYTE>(FVIRTKEY | FCONTROL), VK_ADD, MX_M_VIEW_FONT_ENLARGE_FONT } },
		{ FALSE,		MX_M_VIEW_FONT_SHRINK_FONT,						FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_97DD88C0__Shrink_Font, _LEN_97DD88C0 ),						false,	{ static_cast<BYTE>(FVIRTKEY | FCONTROL), VK_SUBTRACT, MX_M_VIEW_FONT_SHRINK_FONT } },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
	...
	LSW_MENU_ITEM CDeusHexMachinaLayout::m_miViewCharSetMenu[] = {
		//bIsSeperator	dwId											bCheckable	bChecked	bEnabled	
		{ FALSE,		MX_M_VIEW_CHAR_SET_ASCII_ANSI,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_470FBFA1_ASCII_A_NSI, _LEN_470FBFA1 ) },
		...
		{ FALSE,		MX_M_VIEW_CHAR_SET_STANDARD,					FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_9B41853F__Standard, _LEN_9B41853F ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_INTERNATIONAL,				FALSE,		FALSE,		TRUE,		MW_MENU_TXT( _T_4DD9B233__International, _LEN_4DD9B233 ) },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
	...
	// View -> Character Set -> Standard menu.
	LSW_MENU_ITEM CDeusHexMachinaLayout::m_miViewCharSetStandardMenu[] = {
		//bIsSeperator	dwId											bCheckable	bChecked	bEnabled	
		{ FALSE,		MX_M_VIEW_CHAR_SET_ASCII,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_807BA8DC__ASCII, _LEN_807BA8DC ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_ASCII_ANSI,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_470FBFA1_ASCII_A_NSI, _LEN_470FBFA1 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_ASCII_OEM,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_4A16753C_ASCII__OEM, _LEN_4A16753C ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_EBCDIC,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_7CFB7587__EBCDIC, _LEN_7CFB7587 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_UNICODE,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_DB5BE63A__Unicode, _LEN_DB5BE63A ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_UTF8,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_4524B804_UTF__8, _LEN_4524B804 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_MACINTOSH,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_C15FE6DB__Macintosh, _LEN_C15FE6DB ) },
	};

	// View -> Character Set -> International menu.
	LSW_MENU_ITEM CDeusHexMachinaLayout::m_miViewCharSetInternationalMenu[] = {
		//bIsSeperator	dwId											bCheckable	bChecked	bEnabled	
		{ FALSE,		MX_M_VIEW_CHAR_SET_ARABIC_WINDOWS,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_70AA9B0F__Arabic__Windows_, _LEN_70AA9B0F ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_ARABIC_ISO,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_9A84344E_Arabic___ISO_, _LEN_9A84344E ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_BALTIC_WINDOWS,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_AF65D397__Baltic__Windows_, _LEN_AF65D397 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_BALTIC_ISO,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_57BDB155_Ba_ltic__ISO_, _LEN_57BDB155 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_CHINESE_SIMP,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_0E858F99_Chinese__Si_mplified_, _LEN_0E858F99 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_CHINESE_TRAD,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_5C9EB386__Chinese__Traditional_, _LEN_5C9EB386 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_CYRILLIC_WINDOWS,			TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_B322F1B2_Cy_rillic__Windows_, _LEN_B322F1B2 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_CYRILLIC_KOI8R,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_DA02E6A6_Cyrillic__K_OI8_R_, _LEN_DA02E6A6 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_CYRILLIC_KOI8U,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_46567AD6_Cyrillic__KOI_8_U_, _LEN_46567AD6 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_CYRILLIC_ISO,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_A8A4B69A_C_yrillic__ISO_, _LEN_A8A4B69A ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_EASTERN_EUR_WINDOWS,			TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_0B5B5DE3__Eastern_Europe__Windows_, _LEN_0B5B5DE3 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_EASTERN_EUR_ISO,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_832DEC00_Eastern_Euro_pe__ISO_, _LEN_832DEC00 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_GREEK_WINDOWS,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_3F987D96__Greek__Windows_, _LEN_3F987D96 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_GREEK_ISO,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_9A8AEB42_Greek__I_SO_, _LEN_9A8AEB42 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_HEBREW_WINDOWS,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_A1F17C4D__Hebrew__Windows_, _LEN_A1F17C4D ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_HEBREW_ISO,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_E9850994_Hebre_w__ISO_, _LEN_E9850994 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_JAPANESE_JIS,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_EAF36EB9__Japanese__Shift_JIS_, _LEN_EAF36EB9 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_JAPANESE_EUC,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_14A26E2D_Japa_nese__EUC_JP_, _LEN_14A26E2D ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_KOREAN,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_163ABE8E__Korean, _LEN_163ABE8E ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_THAI,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_C280ACCE__Thai, _LEN_C280ACCE ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_TURKISH_WINDOWS,				TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_9401B004_T_urkish__Windows_, _LEN_9401B004 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_TURKISH_ISO,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_B51B4222_Turkish__IS_O_, _LEN_B51B4222 ) },
		{ FALSE,		MX_M_VIEW_CHAR_SET_VIETNAMESE,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_E97EC64F__Vietnamese, _LEN_E97EC64F ) },
	};
	...
	LSW_MENU_ITEM CDeusHexMachinaLayout::m_miViewLeftAreaMenu[] = {
		...
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_INT8,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_3315201B_Si_gned_Byte, _LEN_3315201B ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_UINT8,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_334EF671_Unsigned_B_yte, _LEN_334EF671 ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_INT16,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_6CD8017A_Signed__Short, _LEN_6CD8017A ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_UINT16,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_92DB14E9_Unsigned_Sho_rt, _LEN_92DB14E9 ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_INT32,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_8764CF3C_Signed__Int, _LEN_8764CF3C ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_UINT32,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_116870EF__Unsigned_Int, _LEN_116870EF ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_INT64,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_4B86553B_Signed_Int_64, _LEN_4B86553B ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_UINT64,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_A557B365_Unsig_ned_Int64, _LEN_A557B365 ) },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_POINTER16,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_E7EE4F02_Po_inter_16, _LEN_E7EE4F02 ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_POINTER32,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_44D0ED8F_Pointer__32, _LEN_44D0ED8F ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_POINTER64,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_CFA7175A_Point_er_64, _LEN_CFA7175A ) },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_FLOAT10,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_BFC5DA04_Float1_0, _LEN_BFC5DA04 ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_FLOAT11,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_C8C2EA92_Float1_1, _LEN_C8C2EA92 ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_BFLOAT16,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_E6508728__BFloat16, _LEN_E6508728 ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_FLOAT16,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_A8609778_Flo_at16, _LEN_A8609778 ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_FLOAT32,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_7F17E8C9_Float_32, _LEN_7F17E8C9 ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_FLOAT64,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_617EEE6C__Float64, _LEN_617EEE6C ) },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_PCM8,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_1441FD3F__PCM_8, _LEN_1441FD3F ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_PCM16,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_28CBA650_P_CM_16, _LEN_28CBA650 ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_PCM24,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_E403F26B_PC_M_24, _LEN_E403F26B ) },
		{ FALSE,		MX_M_VIEW_LEFT_AREA_PCM32,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_1A00F4A0_PCM_3_2, _LEN_1A00F4A0 ) },
	};
	...
	LSW_MENU_ITEM CDeusHexMachinaLayout::m_miViewRightAreaMenu[] = {
		...
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_INT8,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_3315201B_Si_gned_Byte, _LEN_3315201B ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_UINT8,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_334EF671_Unsigned_B_yte, _LEN_334EF671 ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_INT16,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_6CD8017A_Signed__Short, _LEN_6CD8017A ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_UINT16,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_92DB14E9_Unsigned_Sho_rt, _LEN_92DB14E9 ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_INT32,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_8764CF3C_Signed__Int, _LEN_8764CF3C ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_UINT32,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_116870EF__Unsigned_Int, _LEN_116870EF ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_INT64,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_4B86553B_Signed_Int_64, _LEN_4B86553B ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_UINT64,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_A557B365_Unsig_ned_Int64, _LEN_A557B365 ) },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_POINTER16,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_E7EE4F02_Po_inter_16, _LEN_E7EE4F02 ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_POINTER32,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_44D0ED8F_Pointer__32, _LEN_44D0ED8F ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_POINTER64,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_CFA7175A_Point_er_64, _LEN_CFA7175A ) },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_FLOAT10,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_BFC5DA04_Float1_0, _LEN_BFC5DA04 ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_FLOAT11,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_C8C2EA92_Float1_1, _LEN_C8C2EA92 ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_BFLOAT16,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_E6508728__BFloat16, _LEN_E6508728 ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_FLOAT16,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_A8609778_Flo_at16, _LEN_A8609778 ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_FLOAT32,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_7F17E8C9_Float_32, _LEN_7F17E8C9 ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_FLOAT64,					TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_617EEE6C__Float64, _LEN_617EEE6C ) },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_PCM8,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_1441FD3F__PCM_8, _LEN_1441FD3F ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_PCM16,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_28CBA650_P_CM_16, _LEN_28CBA650 ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_PCM24,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_E403F26B_PC_M_24, _LEN_E403F26B ) },
		{ FALSE,		MX_M_VIEW_RIGHT_AREA_PCM32,						TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_1A00F4A0_PCM_3_2, _LEN_1A00F4A0 ) },
		{ TRUE,			0,												FALSE,		FALSE,		TRUE,		nullptr },
	...
	LSW_MENU_ITEM CDeusHexMachinaLayout::m_miViewHighlightMenu[] = {
		...
		{ FALSE,		MX_M_VIEW_HIGHLIGHTING_AUTO_HIGHLIGHT_OPS,		TRUE,		FALSE,		TRUE,		MW_MENU_TXT( _T_A217AC73_Auto_Highlight_Options, _LEN_A217AC73 ) },
	};
