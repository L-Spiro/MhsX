...
namespace mx {
	...
	public :
		...
		enum MX_OPTIONS_IDS : WORD {
			...
			MX_OI_SEARCH_EX_SEARCH_RANGE,
			MX_OI_SEARCH_EX_SEARCH_RANGE_LOW_LABEL,
			MX_OI_SEARCH_EX_SEARCH_RANGE_HIGH_LABEL,
			MX_OI_SEARCH_EX_SEARCH_RANGE_LOW_COMBO,
			MX_OI_SEARCH_EX_SEARCH_RANGE_HIGH_COMBO,
			MX_OI_SEARCH_EX_SEARCH_RANGE_SET_BUTTON,
			...
			MX_OI_OPEN_PROCESS_TITLE_BAR,
			MX_OI_OPEN_PROCESS_OPENED_BY_L_SPIRO,
			MX_OI_OPEN_PROCESS_PROCESS_NAME,
			MX_OI_OPEN_PROCESS_PROCESS_ID,
			MX_OI_OPEN_PROCESS_32_BIT_FLAG,
			MX_OI_OPEN_PROCESS_INSERT_RANDOM,
			MX_OI_OPEN_PROCESS_TITLE_BAR_ALL,
			MX_OI_OPEN_PROCESS_TITLE_BAR_NONE,
