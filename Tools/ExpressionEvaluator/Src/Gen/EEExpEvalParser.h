...
namespace yy {
  ...
  public:
   ...
   enum yytokentype {
     ...
     EE_AS_FLOAT_MAX = 530,
     EE_AS_FLOAT_MIN = 531,
     EE_AS_FLOAT_TRUE_MIN = 532,
     EE_AS_FLOAT_NAN = 533,
     EE_AS_FLOAT_INF = 534,
     EE_AS_FLOAT_SUBNORM_MAX = 535,
     EE_AS_FLOAT_EPS = 536,
     EE_TRUE = 537,
     EE_FALSE = 538,
     EE_AS_FLOAT_SIGNBIT = 539,
     EE_AS_FLOAT_EXPBITS = 540,
     EE_AS_FLOAT_MANBITS = 541,
     EE_TO_FLOAT32 = 542,
     EE_TO_FLOAT64 = 543,
     EE_TO_INT8 = 544,
     EE_TO_INT16 = 545,
     ...
     EE_TO_UINT64 = 551,
     EE_CLOCK = 552,
     EE_CLOCKS_PER_SEC = 553,
     EE_SECONDS = 554,
     EE_MILLISECONDS = 555,
     EE_MICROSECONDS = 556,
     EE_SECONDS_SINCE_START = 557,
     EE_MILLISECONDS_SINCE_START = 558,
     EE_MICROSECONDS_SINCE_START = 559,
     EE_ASCII = 560,
     EE_BIN = 561,
     EE_BOOL = 562,
     EE_CHR = 563,
     ...
     EE_BARTLETT = 596,
     EE_BLACKMAN = 597,
     EE_BLACKMANHARRIS = 598,
     EE_BLACKMANNUTTAL = 599,
     EE_BOHMAN = 600,
     EE_BOXCAR = 601,
     EE_CHEBWIN = 602,
     EE_COSINE = 603,
     ...
     EE_FLATTOP = 605,
     EE_GAUSSIAN = 606,
     EE_GENERAL_COSINE = 607,
     EE_GENERAL_GUASSIAN = 608,
     EE_GENERAL_HAMMING = 609,
     EE_HAMMING = 610,
     EE_HANN = 611,
     EE_KAISER = 612,
     EE_KAISER_BESSEL = 613,
     EE_LANCZOS = 614,
     EE_NUTTAL = 615,
     EE_PARZEN = 616,
     EE_TAYLOR = 617,
