...
namespace mx {
	...
	enum MX_LAYOUT_TYPES : DWORD {
		...
		MX_FOUND_ADDRESSES_EDIT,
		MX_FOUND_ADDRESSES_MAIN_PAGE,
		MX_FOUND_ADDRESSES_ADDRESS_PAGE,
		MX_FOUND_ADDRESSES_LOCK_PAGE,
		MX_FOUND_ADDRESSES_HOTKEY_PAGE,
		MX_ADD_FOUND_ADDRESS,
		MX_MOVE_ADDRESSES,
		MX_EXP_EVAL,
		MX_CONVERTER,
