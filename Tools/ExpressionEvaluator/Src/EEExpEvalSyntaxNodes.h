...
namespace ee {
	...
	enum EE_NODES {
		...
		EE_N_VECTOR_DOT,
		EE_N_VECTOR_CROSS,
		EE_N_VECTOR_APPEND_IDENT,
		EE_N_VECTOR_APPEND,
		EE_N_VECTOR_ASSIGN,
		EE_N_VECTOR_AT_IDENT,
		EE_N_VECTOR_AT,
		EE_N_VECTOR_CAPACITY_IDENT,
		EE_N_VECTOR_CAPACITY,
		EE_N_VECTOR_CLEAR_IDENT,
		EE_N_VECTOR_CLEAR,
		EE_N_VECTOR_EMPTY_IDENT,
		EE_N_VECTOR_EMPTY,
		EE_N_VECTOR_ERASE_IDENT,
		EE_N_VECTOR_ERASE,
		EE_N_VECTOR_INSERT,
		EE_N_VECTOR_MAX_SIZE_IDENT,
		EE_N_VECTOR_MAX_SIZE,
		EE_N_VECTOR_MAG_IDENT,
		EE_N_VECTOR_MAG,
		EE_N_VECTOR_MAG_SQ_IDENT,
		EE_N_VECTOR_MAG_SQ,
		EE_N_VECTOR_NORMALIZE_IDENT,
		EE_N_VECTOR_NORMALIZE,
		EE_N_VECTOR_RESERVE_IDENT,
		EE_N_VECTOR_RESERVE,
		EE_N_VECTOR_RESIZE_IDENT,
		EE_N_VECTOR_RESIZE,
		EE_N_VECTOR_POP_BACK_IDENT,
		EE_N_VECTOR_POP_BACK,
		EE_N_VECTOR_PUSH_BACK_IDENT,
		EE_N_VECTOR_PUSH_BACK,
		EE_N_VECTOR_SHRINK_TO_FIT_IDENT,
		EE_N_VECTOR_SHRINK_TO_FIT,
		EE_N_VECTOR_SIZE_IDENT,
		EE_N_VECTOR_SIZE,
		EE_N_VECTOR_SUM_IDENT,
		EE_N_VECTOR_SUM,
		EE_N_VECTOR_SWAP_IDENT,
		EE_N_VECTOR_SWAP,
		EE_N_STRING_TOKENIZE_IDENT,
		...
		EE_N_GAUSSIAN,
		EE_N_GENERAL_COSINE,
		EE_N_GENERAL_GAUSSIAN,
		EE_N_GENERAL_HAMMING,
		EE_N_HAMMING,
		EE_N_HANN,
		EE_N_KAISER,
		EE_N_KAISER_BESSEL,
		...
		EE_N_TRAPAZOID_1,
		EE_N_TRAPAZOID_2,
		EE_N_TRAPAZOIDSTRIDED_4,
		EE_N_TRAPAZOIDSTRIDED_5,
		EE_N_CUM_TRAPAZOID_1,
		EE_N_CUM_TRAPAZOID_2,
		EE_N_CUM_TRAPAZOIDSTRIDED_1,
		EE_N_CUM_TRAPAZOIDSTRIDED_2,
		EE_N_SIMPSON_1,
		EE_N_SIMPSON_2,
		EE_N_SIMPSONSTRIDED_4,
		EE_N_SIMPSONSTRIDED_5,
		EE_N_CUM_SIMPSON_1,
		EE_N_CUM_SIMPSON_2,
		EE_N_CUM_SIMPSONSTRIDED_1,
		EE_N_CUM_SIMPSONSTRIDED_2,
		EE_N_ROMB,
		EE_N_ROMBSTRIDED,
	};
