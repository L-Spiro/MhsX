...
namespace mx {
	...
	class CHexEditorCurProcess : public CHexEditorInterface {
	public :
		CHexEditorCurProcess( CProcess &_pProcess );
		virtual ~CHexEditorCurProcess();
		...
		virtual MX_HEX_EDITOR_TYPES			Type() const { return MX_HET_CUR_PROCESS; }
