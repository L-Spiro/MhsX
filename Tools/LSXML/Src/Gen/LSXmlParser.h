...
/* C++ LALR(1) CXmlParser skeleton written by Akim Demaille.  */

#ifndef __LSX_XML_PARSER_H__
# define __LSX_XML_PARSER_H__





#include "LSXmlParserStack.h"
...
char *s;
   ...
   enum yytokentype {
    ...
    CXmlParser (class CXmlLexer * m_peelLexer_yyarg, class CXmlContainer * m_peecContainer_yyarg);
    virtual ~CXmlParser ();
  ...
  private:
    ...
    /* User arguments.  */
    class CXmlLexer * m_peelLexer;
    class CXmlContainer * m_peecContainer;
  };
...
#endif /* ! defined __LSX_XML_PARSER_H__ */
