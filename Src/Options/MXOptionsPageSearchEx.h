...
namespace mx {
	...
	class COptionsPageSearchEx : public COptionsPage {
	public :
		COptionsPageSearchEx( const LSW_WIDGET_LAYOUT &_wlLayout, CWidget * _pwParent, bool _bCreateWidget = true, HMENU _hMenu = NULL, uint64_t _ui64Data = 0 );
