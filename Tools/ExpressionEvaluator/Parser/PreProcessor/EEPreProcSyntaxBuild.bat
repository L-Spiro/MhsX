...
LSUtility.exe "../../Src/PreProcGen/EEPreProcParserLocation.h" -r \r "" -r \n \r\n -r position.hh EEPreProcParserPosition.h -r BISON_LOCATION_HH __EE_SHADERPARSERLOCATION_H__
LSUtility.exe "../../Src/PreProcGen/EEPreProcParserPosition.h" -r \r "" -r \n \r\n -r std::max max -r BISON_POSITION_HH __EE_SHADERPARSERPOSITION_H__ -r "\r\nnamespace yy" "using namespace std;\r\n\r\nnamespace yy"
LSUtility.exe "../../Src/PreProcGen/EEPreProcParserStack.h" -r \r "" -r \n \r\n -r "unsigned int*    height" "size_t height" -r BISON_STACK_HH __EE_SHADERPARSERSTACK_H__
set s1=deque^<T^>^>
set s2=deque^<T^> ^>
