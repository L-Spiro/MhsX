...
namespace mx {
	...
	public :
		...
		enum MX_STRING_THEORY_WINDOW_IDS {
			...
			MX_STW_PREDEF_GROUP,
			MX_STW_MODIFIERS_TREEVIEWLIST,
			MX_STW_ADD_MODIFER,
			MX_STW_EDIT_MODIFER,
			MX_STW_MOVE_MODIFER_UP,
			MX_STW_MOVE_MODIFER_DOWN,
			...
			MX_STW_OUTPUT_GROUP,
			MX_STW_ESCAPE_GROUP,
			MX_STW_ESCAPE_ONLY_NUL,
			MX_STW_ESCAPE_ALL_UNPRINTABLE,
			MX_STW_ESCAPE_ONLY_NUL_AND_BS,
			MX_STW_ESCAPE_ALL_UNPRINTABLE_AND_BS,
			MX_STW_ESCAPE_ALL,
			MX_STW_ESCAPE_STANDARD,
