...
namespace yy {
  ...
  public:
   ...
   enum yytokentype {
     ...
     EE_AS_FLOAT_MAX = 496,
     EE_AS_FLOAT_MIN = 497,
     EE_AS_FLOAT_TRUE_MIN = 498,
     EE_AS_FLOAT_NAN = 499,
     EE_AS_FLOAT_INF = 500,
     EE_AS_FLOAT_SUBNORM_MAX = 501,
     EE_AS_FLOAT_EPS = 502,
     EE_TRUE = 503,
     EE_FALSE = 504,
     EE_AS_FLOAT_SIGNBIT = 505,
     EE_AS_FLOAT_EXPBITS = 506,
     EE_AS_FLOAT_MANBITS = 507,
     EE_TO_FLOAT32 = 508,
     EE_TO_FLOAT64 = 509,
     EE_TO_INT8 = 510,
     EE_TO_INT16 = 511,
     ...
     EE_TO_UINT64 = 517,
     EE_CLOCK = 518,
     EE_CLOCKS_PER_SEC = 519,
     EE_SECONDS = 520,
     EE_MILLISECONDS = 521,
     EE_MICROSECONDS = 522,
     EE_SECONDS_SINCE_START = 523,
     EE_MILLISECONDS_SINCE_START = 524,
     EE_MICROSECONDS_SINCE_START = 525,
     EE_OR = 526,
     EE_AND = 527,
     EE_LOG_NOT = 528,
     EE_UNARY_1SCOMPL = 529,
     EE_UPLUS = 530,
     EE_UMINUS = 531
   };
