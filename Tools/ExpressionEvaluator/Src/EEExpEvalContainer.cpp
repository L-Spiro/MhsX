...
#undef EE_WINDOW_FUNC
					...
					case EE_N_TRAPAZOID_2 : {
						...
						if ( rParm2.ncType == EE_NC_OBJECT ) {
							...
							if ( rDx.ncType == EE_NC_INVALID ) { (*soProcessMe.prResult).ncType = EE_NC_INVALID; EE_ERROR( EE_EC_INVALID_OBJECT ); }
