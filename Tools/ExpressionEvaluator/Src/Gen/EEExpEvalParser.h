...
namespace yy {
  ...
  public:
   ...
   enum yytokentype {
     ...
     EE_FLT_RADIX = 476,
     EE_DECIMAL_DIG = 477,
     EE_FLT_DECIMAL_DIG = 478,
     EE_DBL_DECIMAL_DIG = 479,
     EE_LDBL_DECIMAL_DIG = 480,
     EE_FLT_MIN = 481,
     EE_DBL_MIN = 482,
     EE_LDBL_MIN = 483,
     EE_FLT_TRUE_MIN = 484,
     EE_DBL_TRUE_MIN = 485,
     EE_LDBL_TRUE_MIN = 486,
     EE_FLT_MAX = 487,
     EE_DBL_MAX = 488,
     EE_LDBL_MAX = 489,
     EE_FLT_EPSILON = 490,
     ...
     EE_FLT_MANT_DIG = 496,
     EE_DBL_MANT_DIG = 497,
     EE_LDBL_MANT_DIG = 498,
     EE_FLT_MIN_EXP = 499,
     EE_DBL_MIN_EXP = 500,
     EE_LDBL_MIN_EXP = 501,
     EE_FLT_MIN_10_EXP = 502,
     EE_DBL_MIN_10_EXP = 503,
     EE_LDBL_MIN_10_EXP = 504,
     EE_FLT_MAX_EXP = 505,
     EE_DBL_MAX_EXP = 506,
     EE_LDBL_MAX_EXP = 507,
     EE_FLT_MAX_10_EXP = 508,
     EE_DBL_MAX_10_EXP = 509,
     EE_LDBL_MAX_10_EXP = 510,
     EE_INT8_MIN = 511,
     EE_INT16_MIN = 512,
     EE_INT32_MIN = 513,
     EE_INT64_MIN = 514,
     ...
     EE_UINT32_MAX = 521,
     EE_UINT64_MAX = 522,
     EE_INT_FAST8_MIN = 523,
     EE_INT_FAST16_MIN = 524,
     EE_INT_FAST32_MIN = 525,
     EE_INT_FAST64_MIN = 526,
     EE_INT_LEAST8_MIN = 527,
     EE_INT_LEAST16_MIN = 528,
     EE_INT_LEAST32_MIN = 529,
     EE_INT_LEAST64_MIN = 530,
     EE_INT_FAST8_MAX = 531,
     EE_INT_FAST16_MAX = 532,
     EE_INT_FAST32_MAX = 533,
     EE_INT_FAST64_MAX = 534,
     EE_INT_LEAST8_MAX = 535,
     EE_INT_LEAST16_MAX = 536,
     EE_INT_LEAST32_MAX = 537,
     EE_INT_LEAST64_MAX = 538,
     EE_UINT_FAST8_MAX = 539,
     EE_UINT_FAST16_MAX = 540,
     EE_UINT_FAST32_MAX = 541,
     EE_UINT_FAST64_MAX = 542,
     EE_AS_FLOAT = 543,
     EE_AS_DOUBLE = 544,
     EE_AS_FLOAT24 = 545,
     EE_AS_FLOAT16 = 546,
     ...
     EE_AS_FLOAT_MAX = 550,
     EE_AS_FLOAT_MIN = 551,
     EE_AS_FLOAT_TRUE_MIN = 552,
     EE_AS_FLOAT_NAN = 553,
     EE_AS_FLOAT_INF = 554,
     EE_AS_FLOAT_SUBNORM_MAX = 555,
     EE_AS_FLOAT_EPS = 556,
     EE_TRUE = 557,
     EE_FALSE = 558,
     EE_AS_FLOAT_SIGNBIT = 559,
     EE_AS_FLOAT_EXPBITS = 560,
     EE_AS_FLOAT_MANBITS = 561,
     EE_TO_FLOAT32 = 562,
     EE_TO_FLOAT64 = 563,
     EE_TO_INT8 = 564,
     EE_TO_INT16 = 565,
     ...
     EE_TO_UINT64 = 571,
     EE_CLOCK = 572,
     EE_CLOCKS_PER_SEC = 573,
     EE_SECONDS = 574,
     EE_MILLISECONDS = 575,
     EE_MICROSECONDS = 576,
     EE_SECONDS_SINCE_START = 577,
     EE_MILLISECONDS_SINCE_START = 578,
     EE_MICROSECONDS_SINCE_START = 579,
     EE_ASCII = 580,
     EE_BIN = 581,
     EE_BOOL = 582,
     EE_CHR = 583,
     ...
     EE_BARTLETT = 616,
     EE_BLACKMAN = 617,
     EE_BLACKMANHARRIS = 618,
     EE_BLACKMANNUTTAL = 619,
     EE_BOHMAN = 620,
     EE_BOXCAR = 621,
     EE_CHEBWIN = 622,
     EE_COSINE = 623,
     ...
     EE_FLATTOP = 625,
     EE_GAUSSIAN = 626,
     EE_GENERAL_COSINE = 627,
     EE_GENERAL_GUASSIAN = 628,
     EE_GENERAL_HAMMING = 629,
     EE_HAMMING = 630,
     EE_HANN = 631,
     EE_KAISER = 632,
     EE_KAISER_BESSEL = 633,
     EE_LANCZOS = 634,
     EE_NUTTAL = 635,
     EE_PARZEN = 636,
     EE_TAYLOR = 637,
