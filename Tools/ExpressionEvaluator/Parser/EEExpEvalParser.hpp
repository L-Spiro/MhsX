...
namespace yy {
  ...
  public:
   ...
   enum yytokentype {
     ...
     EE_FLT_RADIX = 388,
     EE_DECIMAL_DIG = 389,
     EE_FLT_DECIMAL_DIG = 390,
     EE_DBL_DECIMAL_DIG = 391,
     EE_LDBL_DECIMAL_DIG = 392,
     EE_FLT_MIN = 393,
     EE_DBL_MIN = 394,
     EE_LDBL_MIN = 395,
     EE_FLT_TRUE_MIN = 396,
     EE_DBL_TRUE_MIN = 397,
     EE_LDBL_TRUE_MIN = 398,
     EE_FLT_MAX = 399,
     EE_DBL_MAX = 400,
     EE_LDBL_MAX = 401,
     EE_FLT_EPSILON = 402,
     ...
     EE_FLT_MANT_DIG = 408,
     EE_DBL_MANT_DIG = 409,
     EE_LDBL_MANT_DIG = 410,
     EE_FLT_MIN_EXP = 411,
     EE_DBL_MIN_EXP = 412,
     EE_LDBL_MIN_EXP = 413,
     EE_FLT_MIN_10_EXP = 414,
     EE_DBL_MIN_10_EXP = 415,
     EE_LDBL_MIN_10_EXP = 416,
     EE_FLT_MAX_EXP = 417,
     EE_DBL_MAX_EXP = 418,
     EE_LDBL_MAX_EXP = 419,
     EE_FLT_MAX_10_EXP = 420,
     EE_DBL_MAX_10_EXP = 421,
     EE_LDBL_MAX_10_EXP = 422,
     EE_OR = 423,
     EE_AND = 424,
     EE_LOG_NOT = 425,
     EE_UNARY_1SCOMPL = 426,
     EE_UPLUS = 427,
     EE_UMINUS = 428
   };
