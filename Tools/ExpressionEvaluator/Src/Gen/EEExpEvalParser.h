...
namespace yy {
  ...
  public:
   ...
   enum yytokentype {
     ...
     EE_ISNAN = 382,
     EE_ISINF = 383,
     EE_BYTESWAPUSHORT = 384,
     EE_BYTESWAPULONG = 385,
     EE_BYTESWAPUINT64 = 386,
     EE_A = 387,
     EE_ALLADI = 388,
     EE_ALPHA = 389,
     EE_B = 390,
     ...
     EE_FLT_RADIX = 448,
     EE_DECIMAL_DIG = 449,
     EE_FLT_DECIMAL_DIG = 450,
     EE_DBL_DECIMAL_DIG = 451,
     EE_LDBL_DECIMAL_DIG = 452,
     EE_FLT_MIN = 453,
     EE_DBL_MIN = 454,
     EE_LDBL_MIN = 455,
     EE_FLT_TRUE_MIN = 456,
     EE_DBL_TRUE_MIN = 457,
     EE_LDBL_TRUE_MIN = 458,
     EE_FLT_MAX = 459,
     EE_DBL_MAX = 460,
     EE_LDBL_MAX = 461,
     EE_FLT_EPSILON = 462,
     ...
     EE_FLT_MANT_DIG = 468,
     EE_DBL_MANT_DIG = 469,
     EE_LDBL_MANT_DIG = 470,
     EE_FLT_MIN_EXP = 471,
     EE_DBL_MIN_EXP = 472,
     EE_LDBL_MIN_EXP = 473,
     EE_FLT_MIN_10_EXP = 474,
     EE_DBL_MIN_10_EXP = 475,
     EE_LDBL_MIN_10_EXP = 476,
     EE_FLT_MAX_EXP = 477,
     EE_DBL_MAX_EXP = 478,
     EE_LDBL_MAX_EXP = 479,
     EE_FLT_MAX_10_EXP = 480,
     EE_DBL_MAX_10_EXP = 481,
     EE_LDBL_MAX_10_EXP = 482,
     EE_AS_FLOAT = 483,
     EE_AS_DOUBLE = 484,
     EE_AS_FLOAT24 = 485,
     EE_AS_FLOAT16 = 486,
     ...
     EE_AS_FLOAT_MAX = 490,
     EE_AS_FLOAT_MIN = 491,
     EE_AS_FLOAT_TRUE_MIN = 492,
     EE_AS_FLOAT_NAN = 493,
     EE_AS_FLOAT_INF = 494,
     EE_AS_FLOAT_SUBNORM_MAX = 495,
     EE_AS_FLOAT_EPS = 496,
     EE_TRUE = 497,
     EE_FALSE = 498,
     EE_AS_FLOAT_SIGNBIT = 499,
     EE_AS_FLOAT_EXPBITS = 500,
     EE_AS_FLOAT_MANBITS = 501,
     EE_TO_FLOAT32 = 502,
     EE_TO_FLOAT64 = 503,
     EE_TO_INT8 = 504,
     EE_TO_INT16 = 505,
     ...
     EE_TO_UINT64 = 511,
     EE_CLOCK = 512,
     EE_CLOCKS_PER_SEC = 513,
     EE_SECONDS = 514,
     EE_MILLISECONDS = 515,
     EE_MICROSECONDS = 516,
     EE_SECONDS_SINCE_START = 517,
     EE_MILLISECONDS_SINCE_START = 518,
     EE_MICROSECONDS_SINCE_START = 519,
     EE_OR = 520,
     EE_AND = 521,
     EE_LOG_NOT = 522,
     EE_UNARY_1SCOMPL = 523,
     EE_UPLUS = 524,
     EE_UMINUS = 525
   };
